        ...
        <div className="container mx-auto px-4 py-6">
            ...
            <div className="flex space-x-2 mb-6 border-b border-gray-700">
                <button
                    ...
                    className={`px-4 py-2 font-medium transition-colors ${vistaActual === 'calificaciones'
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium transition-colors ${vistaActual === 'estadisticas'
                            ? 'border-b-2 border-blue-600 text-blue-400'
                            : 'text-gray-400 hover:text-blue-400'
                        }`}
                >
                            ...
                            <div key={est.curso_id} className="bg-gray-800 rounded-lg shadow p-6">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="w-full bg-gray-700 rounded-full h-2">
                                        <div
                                            className={`h-2 rounded-full transition-all ${est.media_calificaciones >= 9 ? 'bg-green-500' :
                                ...
                                <div className="pt-4 border-t border-gray-700">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className={`text-xl font-bold ${est.porcentaje_asistencia >= 80 ? 'text-green-400' :
                                    ...
                                    <div className="w-full bg-gray-700 rounded-full h-2 mt-2">
                                        <div
                                            className={`h-2 rounded-full transition-all ${est.porcentaje_asistencia >= 80 ? 'bg-green-500' :
